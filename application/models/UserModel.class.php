...
class UserModel
{
    ...
    public function findWithEmailPassword($email, $password)
    {
        ...
        if(empty($user) == true)
        {
            throw new DomainException // cf http://php.net/manual/fr/language.exceptions.php
            (
...
// Rappel definition $this => La variable $ this est une variable intégrée (intégrée à tous les objets) qui pointe sur l'objet actuel. Ou en d'autres termes, $ ceci est une variable spéciale à auto-référencement. Vous utilisez $ this pour accéder aux propriétés et pour appeler d'autres méthodes de la classe en cours.
