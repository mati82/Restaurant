...
class FrontController
{
    ...
    public function __construct()
    {
        ...
        [
            ...
            'variables' =>
            [
                'requestUrl' => $_SERVER['SCRIPT_NAME'], //Contient le nom du script courant. Cela sert lorsque les pages doivent s'appeler elles-mêmes. La constante __FILE__ contient le chemin complet ainsi que le nom du fichier (i.e. inclut) courant.
